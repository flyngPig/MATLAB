 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Wed Mar 23 23:59:51 2016
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME MessageToLog
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void MessageToLog_Outputs_wrapper(real_T *out);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    MessageToLog_Outputs_wrapper(out);
