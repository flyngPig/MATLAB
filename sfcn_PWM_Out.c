 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Mon Mar 21 14:16:03 2016
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME sfcn_PWM_Out
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void sfcn_PWM_Out_Outputs_wrapper(const uint8_T *in,
			const real_T *xD,
			const uint8_T  *pin, const int_T  p_width0);
extern void sfcn_PWM_Out_Update_wrapper(const uint8_T *in,
			real_T *xD,
			const uint8_T  *pin,  const int_T  p_width0);
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    sfcn_PWM_Out_Update_wrapper(in,  xD, pin, p_width0);
}
